<?php
    ...
    $app -> post("/checkout", function() {
        ...
        header("Location: /pj_final_hcode/order/" . $order -> getidorder());
        exit;
    });
    ...
    $app -> post("/forgot", function() {
        $foUser = User::getForgot($_POST["email"], false);
        header("Location: /pj_final_hcode/forgot/sent");
        exit;
    });
    ...
    $app -> post("/profile", function(){
        ...
        if(!isset($_POST["desperson"]) ||
            $_POST["desperson"] === ''
        ) {
            User::setError("Preencha o seu nome.");
            header("Location: /pj_final_hcode/profile");
            exit;
        }
    ...
    $app -> get("/boleto/:idorder", function($idorder) {
        ...
        $path = $_SERVER['DOCUMENT_ROOT'] . DIRECTORY_SEPARATOR . "pj_final_hcode" . DIRECTORY_SEPARATOR . "resource" . DIRECTORY_SEPARATOR . "boletophp" . DIRECTORY_SEPARATOR . "include" . DIRECTORY_SEPARATOR;
    ...
    $app -> post("/profile/change-password", function() {
        ...
        if(!isset($_POST["current_pass"]) || $_POST["current_pass"] === "") { 
            ...
            header("Location: /pj_final_hcode/profile/change-password");
            exit;
        }
